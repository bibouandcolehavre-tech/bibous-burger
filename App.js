...
export default function App() {
  ...
  const addToCart = (item) => { setCart({ ...item, delivery: { method: "delivery", day: DEFAULT_DELIVERY_DAY.id, date: DEFAULT_DELIVERY_DAY.date, dayLabel: DEFAULT_DELIVERY_DAY.dayLabel, slot: null } }); setScreen("cart"); };
