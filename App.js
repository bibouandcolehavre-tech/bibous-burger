      ...
      <ScrollView contentContainerStyle={styles.loyaltyContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.prestigeCard}>
          <View style={styles.prestigeTop}>
            <View style={[styles.prestigeBadge, currentPrestige && { backgroundColor: currentPrestige.softColor, borderColor: currentPrestige.color }]}>
              <Text style={[styles.prestigeBadgeText, currentPrestige && { color: currentPrestige.color }]}>{currentPrestige ? "★".repeat(currentPrestige.level) : "☆"}</Text>
            </View>
