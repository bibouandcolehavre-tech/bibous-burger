...
function BibouPlusHomeCard({ active, customer, onPress }) {
  return <Pressable onPress={onPress} style={styles.bibouPlusShortcut} accessibilityLabel="Découvrir l’abonnement Bibou Plus">
    <View style={styles.bibouPlusShortcutHeader}>
      ...
      <View style={styles.bibouPlusShortcutHeading}><Text style={styles.bibouPlusShortcutEyebrow}>{active ? "ABONNEMENT ACTIF" : "L’ABONNEMENT BIBOU"}</Text><Text style={styles.bibouPlusShortcutName}>Bibou Plus</Text></View>
