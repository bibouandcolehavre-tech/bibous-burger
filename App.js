...
const BURGER_COMPOSITIONS = {
  taurus: [["Burger", "Pain brioché au charbon végétal · Jambon de Parme · Mozzarella"], ["Sauce", "Pesto rosso"], ["Crudités", "Roquette · Tomates fraîches · Oignons caramélisés · Cornichons"]],
  montagnes: [["Burger", "Pain brioché maison · Steak de bœuf frais · Raclette · Bacon"], ["Crudités", "Roquette · Tomates · Oignons caramélisés · Cornichons"]],
  atlas: [["Burger", "Pain brioché noir · Agneau confit au thym et au miel · Chèvre"], ["Sauce", "Barbecue au miel"], ["Crudités", "Roquette · Tomates · Oignons caramélisés · Cornichons"]],
  classique: [["Burger", "Pain brioché maison · Steak de bœuf frais · Cheddar"], ["Crudités", "Roquette · Tomates fraîches · Oignons caramélisés · Cornichons"]],
  duck: [["Burger", "Pain brioché au charbon végétal · Canard effiloché · Mozzarella"], ["Sauce", "Sauce chinoise"], ["Crudités", "Concombre · Oignons caramélisés · Salade thaï"]],
  dynamite: [["Burger", "Pain brioché maison · Tenders de poulet maison · Cheddar"], ["Sauce", "Sauce thaï"], ["Crudités", "Roquette · Chou rouge · Oignons · Cornichons"]],
  "gros-lard": [["Burger", "Pain brioché maison · Steak de bœuf frais · Lard fumé · Fourme d’Ambert AOP"], ["Crudités", "Roquette · Tomate · Oignons caramélisés · Cornichons"]],
  hambagu: [["Burger", "Pain brioché au charbon végétal · Steak hambagu bœuf-porc · Maasdam"], ["Sauce", "Sauce au mirin et au saké"], ["Crudités", "Concombre · Oignons caramélisés · Salade thaï"]],
  basilic: [["Burger", "Pain brioché maison · Steak de bœuf frais · Mozzarella · Chèvre"], ["Sauce", "Pesto verde"], ["Crudités", "Roquette · Tomates · Oignons caramélisés · Cornichons"]],
  pork: [["Burger", "Pain brioché au charbon végétal · Porc effiloché · Mozzarella"], ["Sauce", "Sauce coréenne légèrement pimentée"], ["Crudités", "Concombre · Salade thaï"]],
};
const compositionForProduct = (product) => BURGER_COMPOSITIONS[product.id.replace(/-menu$/, "")] || [];
...
const MENU_SIDES = { id: "sides", title: "UN EXTRA EN PLUS DU MENU ?", options: [{ id: "frites", label: "Deuxième portion de frites maison", price: 3.9 }, { id: "frites-cheddar", label: "Frites cheddar bacon supplémentaires", price: 6.9 }, { id: "tenders", label: "3 Tenders supplémentaires", price: 6.9 }] };
...
const styles = StyleSheet.create(applyAppPalette({
  ...
  detailImage: { width: "100%", height: 230, borderRadius: 25, resizeMode: "cover", marginTop: 14, backgroundColor: "#EADBD2" }, priceRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 18 }, detailTitle: { color: "#2C201B", fontSize: 26, fontWeight: "900", letterSpacing: -1, flex: 1, paddingRight: 14 }, detailPrice: { color: "#2C201B", fontSize: 16, fontWeight: "800" }, detailDescription: { color: "#826E63", lineHeight: 20, marginTop: 7 }, detailComposition: { backgroundColor: "#FFFDFC", borderWidth: 1, borderColor: "#EADBD2", borderRadius: 18, padding: 15, marginTop: 14, gap: 11 }, detailCompositionSection: { gap: 2 }, detailCompositionTitle: { color: "#D74318", fontSize: 12, fontWeight: "900", textTransform: "uppercase", letterSpacing: 0.5 }, detailCompositionItem: { color: "#493A33", fontSize: 13, lineHeight: 19, fontWeight: "600" }, includedText: { color: "#397353", fontSize: 13, fontWeight: "700", marginTop: 10 },
  optionGroup: { backgroundColor: "#FFFDFC", borderWidth: 1, borderColor: "#EADBD2", borderRadius: 16, overflow: "hidden", marginBottom: 14 }, optionGroupHeader: { minHeight: 70, padding: 14, flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#F8EAE0" }, optionGroupTitleWrap: { flex: 1, paddingRight: 10 }, optionGroupTitle: { color: "#2C201B", fontSize: 12, fontWeight: "900", letterSpacing: 0.2 }, optionGroupHelper: { color: "#826E63", fontSize: 12, marginTop: 5 }, option: { minHeight: 64, paddingHorizontal: 13, paddingVertical: 8, flexDirection: "row", alignItems: "center", borderBottomColor: "#EADBD2", borderBottomWidth: 1, backgroundColor: "#FFFDFC" }, optionSelected: { backgroundColor: "#FFF0E9", borderLeftWidth: 4, borderLeftColor: "#E95122", paddingLeft: 9 }, checkbox: { width: 23, height: 23, borderColor: "#CBB7AA", borderWidth: 1.5, borderRadius: 7, alignItems: "center", justifyContent: "center", marginRight: 11 }, checkboxSelected: { backgroundColor: "#E95122", borderColor: "#E95122" }, checkmark: { color: "white", fontWeight: "900" }, optionName: { color: "#2C201B", flex: 1, fontSize: 13, fontWeight: "700", paddingRight: 8 }, optionNameSelected: { color: "#98452F", fontWeight: "900" }, optionValue: { color: "#826E63", fontSize: 12, fontWeight: "800" }, optionDrinkImage: { width: 52, height: 52, resizeMode: "contain", marginRight: 10 }, optionDrinkFallback: { width: 52, height: 52, borderRadius: 14, backgroundColor: "#F5EBDD", alignItems: "center", justifyContent: "center", marginRight: 10 }, optionDrinkFallbackText: { fontSize: 25 }, saucePot: { width: 52, height: 48, alignItems: "center", justifyContent: "center", marginRight: 10 }, saucePotLid: { width: 42, height: 7, borderRadius: 5, backgroundColor: "#C8B8AD", borderWidth: 1, borderColor: "#A89387", zIndex: 2 }, saucePotCup: { width: 36, height: 31, marginTop: -1, borderBottomLeftRadius: 10, borderBottomRightRadius: 10, borderWidth: 2, borderTopWidth: 1, borderColor: "#B9AAA1", backgroundColor: "#EEE7E2", padding: 4, justifyContent: "flex-end" }, saucePotFill: { height: 18, borderBottomLeftRadius: 6, borderBottomRightRadius: 6, borderTopLeftRadius: 3, borderTopRightRadius: 3 },
