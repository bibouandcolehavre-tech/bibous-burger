...
const DRINK_PRODUCTS = [
  { id: "drink-coca", name: "Coca 33 cl", price: 1.8, kind: "simple", emoji: "🥤", image: { uri: "https://images.sumup.com/img_3SQ6W89DJ19MJVBHTPJ7R70TG1/image.png" }, description: "Canette 33 cl bien fraîche." },
  { id: "drink-coca-cherry", name: "Coca Cherry 33 cl", price: 1.8, kind: "simple", emoji: "🥤", image: { uri: "https://images.sumup.com/img_4F3F6NA7PH8X9RT8BV7PVYRCX6/image.png" }, description: "Canette 33 cl bien fraîche." },
  { id: "drink-fuse-menthe", name: "Fuse Tea thé vert menthe", price: 1.8, kind: "simple", emoji: "🧊", image: { uri: "https://images.sumup.com/img_2VWGZCY2ST8YJREQA8V1V0CN0W/image.png" }, description: "Boisson rafraîchissante au thé vert et à la menthe." },
  { id: "drink-lipton-framboise", name: "Lipton framboise 33 cl", price: 1.8, kind: "simple", emoji: "🧊", image: { uri: "https://images.sumup.com/img_2DHV5AS8C58B8SAASCR971F5BN/image.png" }, description: "Canette 33 cl bien fraîche." },
  { id: "drink-lipton-peche", name: "Lipton pêche 33 cl", price: 1.8, kind: "simple", emoji: "🧊", image: { uri: "https://images.sumup.com/img_22TJJR8PH28FZT4X64DHC3NBPC/image.png" }, description: "Canette 33 cl bien fraîche." },
  { id: "drink-oasis-pomme", name: "Oasis pomme cassis framboise", price: 1.8, kind: "simple", emoji: "🥤", image: { uri: "https://images.sumup.com/img_76XXR19NWZ8179S1SVRAZ9M3R5/image.png" }, description: "Boisson fruitée bien fraîche." },
  { id: "drink-oasis-tropical", name: "Oasis tropical", price: 1.8, kind: "simple", emoji: "🥤", image: { uri: "https://images.sumup.com/img_7G13CKRVHH9ZJTVXCN53G23DR3/image.png" }, description: "Boisson tropicale bien fraîche." },
  { id: "drink-perrier", name: "Perrier", price: 1.8, kind: "simple", emoji: "💧", image: { uri: "https://images.sumup.com/img_4HEVB6RXNK8WP8BB2KH1A3QWDV/image.png" }, description: "Eau gazeuse bien fraîche." },
  { id: "drink-tropico", name: "Tropico", price: 1.8, kind: "simple", emoji: "🥤", image: { uri: "https://images.sumup.com/img_207RANDJWX9S48P006J5F7GXWZ/image.png" }, description: "Boisson aux fruits bien fraîche." },
];
...
const styles = StyleSheet.create(applyAppPalette({
  ...
  header: { minHeight: 52, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, headerBrand: { flexDirection: "row", alignItems: "center" }, wordmarkBadge: { width: 132, height: 48, borderRadius: 13, backgroundColor: "#123FC7", alignItems: "center", justifyContent: "center", overflow: "hidden", paddingHorizontal: 7, paddingVertical: 4, shadowColor: "#10254D", shadowOpacity: 0.18, shadowRadius: 5, shadowOffset: { width: 0, height: 3 }, elevation: 3 }, wordmarkBadgeDesktop: { width: 150, height: 54 }, wordmarkImage: { width: 118, height: 40 }, wordmarkImageDesktop: { width: 136, height: 46 }, headerRight: { fontSize: 18 }, backButton: { width: 38, height: 38, borderRadius: 12, backgroundColor: "#F8EAE0", alignItems: "center", justifyContent: "center" }, backText: { fontSize: 30, lineHeight: 32, color: "#2C201B" },
  ...
  categoryHeaderTitle: { color: "#FFFFFF", fontSize: 18, fontWeight: "900", letterSpacing: 0.2 },
  categoryHeaderSubtitle: { color: "#DCE8FF", fontSize: 12, fontWeight: "700", marginTop: 3 },
