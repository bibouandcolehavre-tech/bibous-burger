...
function AccountScreen({ onOpenNotifications, customer, loyalty, orders, reservations, onBack, onOpenOrders, onOpenReservations, onOpenLoyalty, onOpenBibouPlus, onOpenPrivacy, onDeleteAccount, onLogout }) {
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const stop = observePush(data => {
      ...
      if (!['menu', 'orders', 'reservations', 'loyalty', 'bibou-plus', 'reservation'].includes(data.screen)) return;
