...
L’identité et le téléphone ont été transmis à Apple avec accord du propriétaire ; aucune copie des coordonnées personnelles dans ce dépôt. Le propriétaire a confirmé que BIBOU & CO est une SAS et demandé l’inscription au nom de la société. Type « Company / Organization » sélectionné ; formulaire `https://developer.apple.com/enroll/organization/details/edit/legal-entity` prérempli avec la raison sociale. Apple demande le D-U-N-S (différent du SIREN), encore inconnu. La recherche officielle `https://developer.apple.com/enroll/duns-lookup/#!/search` est préremplie avec les informations publiques de la société, sans soumission. Elle demande notamment une adresse e-mail liée au domaine de l’entreprise, non fournie à ce stade, et un CAPTCHA (à faire par le propriétaire ou à autoriser au moment de l’action). Ne pas substituer le SIREN au D-U-N-S, inventer un domaine ni souscrire un domaine sans accord. Tarif officiel consulté le 19 septembre : 99 USD par an, prix local affiché pendant l’inscription ; aucun montant exact en euros encore présenté. L’autorisation de préparer la suite ne vaut pas accord de paiement. Source : https://developer.apple.com/programs/enroll/.
